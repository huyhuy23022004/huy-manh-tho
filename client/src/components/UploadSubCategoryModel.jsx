            ...
            <form className='my-3 grid gap-3' onSubmit={handleSubmitSubCategory}>
                    ...
                    <div className='grid gap-1'>
                        ...
                        <div className='flex flex-col lg:flex-row items-center gap-3'>
                            ...
                            <label htmlFor='uploadSubCategoryImage'>
                                <div className='px-4 py-1 border border-amber-100 text-amber-200 rounded hover:bg-amber-200 hover:text-neutral-900 cursor-pointer  '>
                                    Upload Image
                                </div>
                                <input 
                                    type='file'
                    ...
                    <button
                        className={`px-4 py-2 border
                            ${subCategoryData?.name && subCategoryData?.image && subCategoryData?.category[0] ? "bg-amber-200 hover:bg-amber-100" : "bg-gray-200"}    
                            font-semibold
                        `}
                    >
                        Submit
