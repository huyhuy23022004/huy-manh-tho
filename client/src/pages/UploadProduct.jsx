    ...
    <section className="">
      ...
      <div className="grid p-3">
        <form className="grid gap-4"onSubmit={handleSubmit}>
          ...
          <div onClick={()=>setOpenAddField(true)} className=' hover:bg-amber-200 bg-white py-1 px-3 w-32 text-center font-semibold border border-amber-200 hover:text-neutral-900 cursor-pointer rounded'>
                  Add Fields
          </div>

          <button className='bg-amber-100 hover:bg-amber-200 py-2 rounded font-semibold'>
                  Submit
          </button>
        </form>
      </div>
