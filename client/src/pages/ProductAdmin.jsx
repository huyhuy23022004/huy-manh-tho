...
export default function ProductAdmin() {
  ...
  return (
    <section className=''>
      ...
      <div className='flex justify-between my-4'>
        <button onClick={handlePrevious} className="border border-amber-200 px-4 py-1 hover:bg-amber-200">Previous</button>
        <button className='w-full bg-slate-100'>{page}/{totalPageCount}</button>
        <button onClick={handleNext} className="border border-amber-200 px-4 py-1 hover:bg-amber-200">Next</button>
      </div>
    </section>
  )
}
